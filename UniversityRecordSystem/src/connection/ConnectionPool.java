...
//http://www.onjava.com/2006/04/19/database-connection-pooling-with-tomcat.html
//http://geekexplains.blogspot.com/2008/06/what-is-connection-pooling-why-do-we.html
...
public class ConnectionPool implements Runnable{
	int initialallowableConnections = 100;
	  ...
	  private ConnectionPool(){
		  //below parameters we have to change according every group member's database settings 
	    this.SQLdriver = "com.mysql.jdbc.Driver";
	    this.waitIncaseBusy = true;
	    this.SQLusername = "root";
	    this.SQLpassword = "root";//password also change 
	    	    this.SQLurl = "jdbc:mysql://localhost:3306/cmpe273";// url change
	  ...
	  public synchronized Connection getConnection()throws SQLException {
		  System.out.println("Connectionpool class-getConnection is called");		  
		    if (!connectionsAvailable.isEmpty()) {
		      ...
		      if ((Connections_total() < maxallowableConnections) && !pendingConnection) {
		        ...
		        throw new SQLException("Connection limit has reached");
		      }
		     try {
		        wait();
	  ...
	  private Connection createNewConnection() throws SQLException {
		    try {
		      ...
		      return(newConnection);
		    	...
		    	throw new SQLException("Could't find class for driver: " + SQLdriver);
		    }
		  }
